...
def four_legged_walk(head, tail, step_duration = 0.5):
    ...
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, -40), (3, 0), (4, 0), (1, 0)])
    ...
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, -40), (3, -20), (4, 0), (1, 0)])
    ...
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, 0), (3, -20), (4, 0), (1, 0)])
    ...
    #Straighten all legs
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, 0), (3, 0), (4, 0), (1, 0)])
    ...
    #Move two alternating legs forward
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, 0), (3, 40), (4, 0), (1, 0)])
    ...
    #Move other two legs backward
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, 20), (3, 40), (4, 0), (1, 0)])
    ...
    #Straighten first two legs
    temp_sequence_1 = head.keyframe(step_duration, 4, [(0, 20), (3, 0), (4, 0), (1, 0)])
